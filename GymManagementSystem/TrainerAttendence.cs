...
namespace GymManagementSystem
{
    public partial class TrainerAttendence : Form
    {
        ...
        private void TrainerAttendence_Load(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-JEHSF5C;Initial Catalog=GymManagement;User ID=sa;Password=42528");
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT * FROM TRN", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-JEHSF5C;Initial Catalog=GymManagement;User ID=sa;Password=42528");
            con.Open();
            SqlCommand cmd = new SqlCommand("UPDATE TRN SET  Attendence=@Attendence, Attendence_Time=@Attendence_Time WHERE T_ID = @T_ID", con);
